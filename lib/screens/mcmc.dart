          ...
          child: Stack(
            children: <Widget>[
              ...
              Positioned(
                ...
                child: Text("MCMC provide an Internship Opportunities for students and a "
                    "career with them and if anyone interested they can send application "
                    "by email to them", style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w400,
                ),
                ),
                    ...
                    children: [
                      ...
                      TextSpan(
                        ...
                        recognizer: new TapGestureRecognizer()..onTap = () async {
                          var url = "https://www.mcmc.gov.my/en/home";
